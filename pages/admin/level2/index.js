...
export default function Level1() {
  ...
  async function accept(e, uid, id) {
    ...
    await deleteDoc(doc(firestore, `level2`, id));

    toast.success("User is now level 2");
  }
  ...
  useEffect(() => {
    let unsub = onSnapshot(
      ...
      (data) => {
        ...
        setUsers(array);
        setUserCursor(array[array.length - 1]?.level2id);
  ...
  async function loadMoreUsers(e) {
    ...
    await getDocs(
      ...
      setUserCursor(prevArray[prevArray.length - 1]?.level2id);
